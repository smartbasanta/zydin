        ...
        <table class="w-full min-w-[600px] text-sm">
            <thead class="bg-section-bg top-0 relative">
                <tr class="text-muted">
                    ...
                    >
                        <Dropdown v-if="col.sortable" placement="bottom-center" menuClass="menu-dropdown-panel">
                            <template #trigger="{ toggle }">
                                <button
                                    @click="toggle()"
                                    class="btn text-sm font-normal !no-underline"
            ...
            <tbody>
                <template v-if="dataToDisplay && dataToDisplay.length > 0">
                    <tr v-for="row in dataToDisplay" :key="row.id" class="table-row"
